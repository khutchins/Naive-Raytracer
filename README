...
It can encorporate the following scene elements:
Planes
Spheres
Cameras
Point Lights
...
The following scene elements are currently being implemented:
Tubes
Cylinders
...
This code is being run in Windows. Doesn't currently work on Linux/Mac. Sorry.
